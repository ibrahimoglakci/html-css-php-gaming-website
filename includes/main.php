<main>
    <section id="hero-image">
        <div class="hero-marketing-text">
            ...
            <h5>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec malesuada lorem maximus mauris
                scelerisque, at rutrum nulla dictum. Ut ac ligula sapien. Suspendisse cursus faucibus finibus. </h5>
        ...
        <div class="flex">
            ...
            <div id="latest-news-container">
                <div class="latest-news-item">
                    ...
                    <span class="latest-news-text">Lorem ipsum dolor sit amet, consectectur adipiscing elit
                        ipsum.</span>
                </div>
            </div>
        </div>
        ...
        <div class="flex">
            ...
            <div class="box">
                ...
                <div class="tournaments-content">
                    ...
                    <div><label class="prizes">Prizes:</label> <label>1st place $2000, 2nd place: $1000, 3rd place:
                            $500</label></div>
                </div>
            </div>
    ...
    <section id="posts-comments">
        <div class="flex">
            <div class="game-warrior">
                <a href="#"><img src="assets/logo/tsd-dark.png" alt="Team Software Development" width="55px;"
                        height="auto;" /> <span
                        style='font-weight: 600; font-size: 22px; color: white; text-decoration: none; text-align: center;'>Team
                        Software
                        Development</span></a>
                <p>Lorem ipsum dolor sit amet, consectectur adipiscing ipsum dolor sit amet.</p>
            ...
            <div class="posts-comments-box">
                ...
                <div class="comments-item">
                    ...
                    <div>
                        <p><span class="author">James Smith</span> <span>on</span> Lorem ipsum dolor sit amet
                            consectectur.</p>
                        <h5>June 21, 2019</h5>
                    </div>
                </div>
